...
$db = "if0_39808481_user_registration";
$user = "if0_39808481";
$pass = "sZx9kuWVcCO";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['Submit'])) {
        ...
        if ($usernameErr || $passwordErr) {
            ...
            $sql = "SELECT username, name, surname, email, gender FROM users WHERE username='$username' OR email='$username' AND password='$password'";
        ...
        <div class="FormB">
            ...
            <div class="form-group">
                <div class="form-row">
                    ...
                    <input type="submit" name="admin" value="Admin" class="admin">
                </div>
            </div>
